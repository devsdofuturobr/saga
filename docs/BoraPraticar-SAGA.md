# Orquestrando microserviços com SAGA: falhou? Compensa! 😎🚀
...
Manual (se quiser acionar direto):
...
- Marque o repositório com uma estrela e salva para estudar depois: https://github.com/devsdofuturobr/saga.git ⭐
